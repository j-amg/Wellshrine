...
public partial class SignalManager : Node
{
	...
	[Signal] public delegate void PlayerHealthChangedEventHandler(Player player);
	[Signal] public delegate void PlayerDamageExecutedEventHandler(DamagePackage damagePackage);
